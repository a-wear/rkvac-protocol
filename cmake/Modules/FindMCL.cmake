...
``MCL::Bn512``
  The MCL ``mclbn512`` library, if found.
...
find_library(MCL_BN512_LIBRARY
  NAMES
    mclbn512
  PATHS
    ${MCL_ROOT_DIR}
...
if (MCL_FOUND)
  ...
  if (NOT TARGET MCL::Bn512 AND (EXISTS "${MCL_BN512_LIBRARY}"))
    add_library(MCL::Bn512 UNKNOWN IMPORTED)
    set_target_properties(MCL::Bn512 PROPERTIES
      INTERFACE_INCLUDE_DIRECTORIES "${MCL_INCLUDE_DIR}")
    if (EXISTS "${MCL_BN512_LIBRARY}")
      set_target_properties(MCL::Bn512 PROPERTIES
        IMPORTED_LINK_INTERFACE_LANGUAGES "C"
        IMPORTED_LOCATION "${MCL_BN512_LIBRARY}")
    endif ()
  endif ()
endif ()
